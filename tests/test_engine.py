...
class EngineTests(unittest.TestCase):
    def test_question_bank_is_valid_and_balanced(self):
        ...
        self.assertEqual(stats["total"], 301)
        ...
        self.assertEqual(len({q["explanation"] for q in bank}), 301)
    ...
    def test_choice_lengths_and_answer_positions_are_balanced(self):
        ...
        self.assertEqual(sum(positions.values()), 181)
        self.assertEqual(set(positions), set("ABCD"))
